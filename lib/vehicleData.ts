...
const europeanBrands: VehicleBrand[] = [
  ...
  { id: 'brand-opel', name: 'Opel', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 11 },
  { id: 'brand-seat', name: 'Seat', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 12 },
  { id: 'brand-skoda', name: 'Skoda', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 13 },
  { id: 'brand-landrover', name: 'Land Rover', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 14 },
  { id: 'brand-jaguar', name: 'Jaguar', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 15 },
  { id: 'brand-mini', name: 'Mini', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 16 },
  { id: 'brand-alfaromeo', name: 'Alfa Romeo', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 17 },
];

// Marques japonaises
const japaneseBrands: VehicleBrand[] = [
  { id: 'brand-toyota', name: 'Toyota', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 18 },
  { id: 'brand-honda', name: 'Honda', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 19 },
  { id: 'brand-nissan', name: 'Nissan', modelPath: '/models/placeholder.gltf', startYear: 2010, order: 20 },
